...
| proxy             | string | Access instagram through a proxy server                                          |                                | Without authentication: proxy:port, example: 10.10.1.10:3128, with authentication: user:pass@proxy:port, example: mike:d23dedf@10.10.1.10:3128 |
